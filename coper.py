...
def predict_status(ctry,itmtp,aplcn,wth,prdrf,qtlg,cstlg,tknslg,slgplg,itmdt,itmmn,itmyr,deldtdy,deldtmn,deldtyr):
    ...
    with open("C:\\Users\\charu\\OneDrive\\Desktop\\kc.py\\Classification_model.pkl","rb") as f:
...
def predict_selling_price(ctry,sts,itmtp,aplcn,wth,prdrf,qtlg,cstlg,
    ...
    dydy= int(deldtyr)
    #modelfile of the classification
    with open("C:\\Users\\charu\\OneDrive\\Desktop\\kc.py\\Regression_Model.pkl","rb") as f:
...
with st.sidebar:
    option = option_menu('Charu', options=["PREDICT SELLING PRICE", "PREDICT STATUS"])
